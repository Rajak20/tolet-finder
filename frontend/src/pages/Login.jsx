    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm">Log in to continue to ToLetFinder.</p>
        </div>
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-2xl p-6">
          ...
          <p className="text-sm text-center mt-5 text-gray-400">
            Don't have an account? <a href="/register" className="text-emerald-400 font-medium hover:text-emerald-300">Sign up</a>
          </p>
